...
ctld.fastRopeMaximumHeight = 20.00 -- in meters which is 60 ft max fast rope (not rappell) safe height
...
ctld.buildTimeFOB = 90 --time in seconds for the FOB to be built
...
ctld.deployedBeaconBattery = 60 -- the battery on deployed beacons will last for this number minutes before needing to be re-deployed
...
ctld.JTAC_smokeMarginOfError = 0 -- error that the JTAC is allowed to make when popping a smoke (in meters)
ctld.JTAC_smokeOffset_x = 0.0 -- distance in the X direction from target to smoke (meters)
ctld.JTAC_smokeOffset_y = 10.0 -- distance in the Y direction from target to smoke (meters)
...
ctld.pickupZones = {
    { "Luostari Supply", "blue", -1, "yes", 0 },
    { "Ivalo Supply", "blue", -1, "yes", 0 },
...
ctld.loadableGroups = {
    ...
    {name = ctld.i18n_translate("Anti Air"), inf = 2, aa = 2  },
    {name = ctld.i18n_translate("Anti Tank"), inf = 2, at = 6  },
    {name = ctld.i18n_translate("Mortar Squad"), mortar = 5 },
...
ctld.spawnableCrates = {
	...
	["Combat Vehicles"] = {
        ...
        --- BLUE
		{ weight = 500.10, desc = ctld.i18n_translate("M1128 Stryker MGS"), unit = "M1128 Stryker MGS", side = 2 },
		{ weight = 500.01, desc = ctld.i18n_translate("M-60A3 Patton"), unit = "M-60", side = 2 },  --careful with the names as the script matches the desc to JTAC types
        { weight = 500.02, desc = ctld.i18n_translate("Humvee - TOW"), unit = "M1045 HMMWV TOW", side = 2 },
        { weight = 500.07, desc = ctld.i18n_translate("M1134 Stryker ATGM"), unit = "M1134 Stryker ATGM", side = 2 },		
        { weight = 500.06, desc = ctld.i18n_translate("LAV-25"), unit = "LAV-25", side = 2 },
		{ weight = 500.04, desc = ctld.i18n_translate("M2A2 Bradley"), unit="M-2 Bradley", side = 2 },
        { weight = 500.09, desc = ctld.i18n_translate("ATGM VAB Mephisto"), unit="VAB_Mephisto", side = 2 },
        { weight = 500.05, desc = ctld.i18n_translate("M1A2C Abrams"), unit="M1A2C_SEP_V3", side = 2, },

        --- RED
        { weight = 511.01, desc = ctld.i18n_translate("BTR-82A"), unit = "BTR-82A", side = 1 },
        { weight = 511.02, desc = ctld.i18n_translate("BRDM-2"), unit = "BRDM-2", side = 1 },
        { weight = 511.03, desc = ctld.i18n_translate("BMP-3"), unit = "BMP-3", side = 1 },
        { weight = 511.04, desc = ctld.i18n_translate("T-55"), unit = "T-55", side = 1 },		
        { weight = 511.05, desc = ctld.i18n_translate("T-72B3"), unit = "T-72B3", side = 1 },		
        -- need more redfor!
    },
    ["Support"] = {
        --- BLUE
        { weight = 501.01, desc = ctld.i18n_translate("MRAP - JTAC"), unit = "MaxxPro_MRAP", side = 2 }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
        { weight = 501.02, desc = ctld.i18n_translate("M-818 Ammo Truck"), unit = "M 818", side = 2 },
        { weight = 501.03, desc = ctld.i18n_translate("M-978 Tanker"), unit = "M978 HEMTT Tanker", side = 2 },
		{ weight = 501.21, desc = ctld.i18n_translate("EWR Radar FPS-117"), unit="FPS-117", side = 2 },
	
         --- RED
        { weight = 501.11, desc = ctld.i18n_translate("Tigr - JTAC"), unit = "Tigr_233036", side = 1 }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
        { weight = 501.12, desc = ctld.i18n_translate("Ural-4320-31 Ammo Truck"), unit = "Ural-4320-31", side = 1 },
        { weight = 501.13, desc = ctld.i18n_translate("ATZ-10 Refueler"), unit = "ATZ-10", side = 1 },
		{ weight = 501.23, desc = ctld.i18n_translate("EWR Radar 1L13"), unit="1L13 EWR", side = 1 },		

        --- Both
        { multiple = {501.22, 501.22, 501.22}, desc = ctld.i18n_translate("FOB Crates - All") },		
        { weight = 501.22, desc = ctld.i18n_translate("FOB Crate - Small"), unit = "FOB-SMALL" }, -- Builds a FOB! - requires 3 * ctld.cratesRequiredForFOB

    },
    ["Artillery"] = {
        --- BLUE
        { weight = 502.01, desc = ctld.i18n_translate("MLRS"), unit = "MLRS", side = 2, cratesRequired = 2 },
		{ weight = 502.07, desc = ctld.i18n_translate("Smerch_CM"), unit = "Smerch", side = 2, cratesRequired = 2 },		
        { weight = 502.03, desc = ctld.i18n_translate("L118 Light Artillery 105mm"), unit = "L118_Unit", side = 2 },
        { weight = 502.06, desc = ctld.i18n_translate("Smerch_HE"), unit = "Smerch_HE", side = 2, cratesRequired = 2 },
        { weight = 502.04, desc = ctld.i18n_translate("M-109"), unit = "M-109", side = 2, cratesRequired = 2 },


        --- RED
        { weight = 502.12, desc = ctld.i18n_translate("SAU Gvozdika"), unit = "SAU Gvozdika", side = 1, cratesRequired = 2 },
        { weight = 502.11, desc = ctld.i18n_translate("SPH 2S19 Msta"), unit = "SAU Msta", side = 1, cratesRequired = 2 },
		{ weight = 502.14, desc = ctld.i18n_translate("Uragan_BM-27"), unit = "Uragan_BM-27", side = 1, cratesRequired = 2 },
		{ weight = 502.13, desc = ctld.i18n_translate("BM-21 Grad Ural"), unit = "Grad-URAL", side = 1, cratesRequired = 2 },
		{ weight = 502.15, desc = ctld.i18n_translate("PLZ-05 Mobile Artillery"), unit = "PLZ05", side = 1, cratesRequired = 2 },		
    },
	
    ["AAA"] = {
        --- BLUE
        { weight = 508.04, desc = ctld.i18n_translate("Gepard AAA"), unit = "Gepard", side = 2 },
        { weight = 508.05, desc = ctld.i18n_translate("LPWS C-RAM"), unit = "HEMTT_C-RAM_Phalanx", side = 2 },
		{ weight = 508.06, desc = ctld.i18n_translate("SPAAA Vulcan M163"), unit = "Vulcan", side = 2 },
		{ weight = 508.09, desc = ctld.i18n_translate("Bofors 40mm"), unit = "bofors40", side = 2 },
	
        --- RED
        { weight = 508.11, desc = ctld.i18n_translate("Ural-375 ZU-23"), unit = "Ural-375 ZU-23", side = 1, cratesRequired = 1 },
        { weight = 508.12, desc = ctld.i18n_translate("ZSU-23-4 Shilka"), unit = "ZSU-23-4 Shilka", side = 1, cratesRequired = 1 },
		{ weight = 508.13, desc = ctld.i18n_translate("ZSU_57_2"), unit = "ZSU_57_2", side = 1, cratesRequired = 1 },

    },	
	
    ["SAM short range"] = {
        --- BLUE
        { weight = 503.01, desc = ctld.i18n_translate("M1097 Avenger"), unit = "M1097 Avenger", side = 2, cratesRequired = 2 },
        { weight = 503.02, desc = ctld.i18n_translate("M48 Chaparral"), unit = "M48 Chaparral", side = 2, cratesRequired = 2 },
        { weight = 503.03, desc = ctld.i18n_translate("Roland ADS"), unit = "Roland ADS", side = 2, cratesRequired = 2 },
        { weight = 503.05, desc = ctld.i18n_translate("M6 Linebacker"), unit = "M6 Linebacker", side = 2 },
		 -- Rapier System
		{ multiple = {507.01, 507.02, 507.03}, desc = ctld.i18n_translate("Rapier - All crates"), side = 2 },
        { weight = 507.01, desc = ctld.i18n_translate("Rapier Launcher"), unit = "rapier_fsa_launcher", side = 2 },
        { weight = 507.02, desc = ctld.i18n_translate("Rapier SR"), unit = "rapier_fsa_blindfire_radar", side = 2 },
        { weight = 507.03, desc = ctld.i18n_translate("Rapier Tracker"), unit = "rapier_fsa_optical_tracker_unit", side = 2 },
        { weight = 507.04, desc = ctld.i18n_translate("Rapier Repair"), unit = "Rapier Repair" , side = 2 },
        -- End of Rapier

        --- RED
        { weight = 503.11, desc = ctld.i18n_translate("9K33 Osa"), unit = "Osa 9A33 ln", side = 1, cratesRequired = 2 },
        { weight = 503.12, desc = ctld.i18n_translate("9P31 Strela-1"), unit = "Strela-1 9P31", side = 1, cratesRequired = 2 },
        { weight = 503.15, desc = ctld.i18n_translate("2K22 Tunguska"), unit = "2S6 Tunguska", side = 1, cratesRequired = 2 },
        { weight = 503.16, desc = ctld.i18n_translate("SA-13 Strela-10M3"), unit = "Strela-10M3", side = 1, cratesRequired = 2 },

        -- HQ-7
		{ multiple = {503.20, 503.20, 503.21}, desc = ("HQ-7 - All crates"), side = 1 },       
	    { weight = 503.20, desc = ctld.i18n_translate("HQ-7_Launcher"), unit = "HQ-7_LN_SP", side = 1, cratesRequired = 2 },
        { weight = 503.21, desc = ctld.i18n_translate("HQ-7_STR_SP"), unit = "HQ-7_STR_SP", side = 1 },
        { weight = 503.23, desc = ctld.i18n_translate("HQ-7 Repair"), unit = "HQ-7 Repair", side = 1 },
        -- End of HQ-7
    ...
    ["SAM mid range"] = {
        --- BLUE
        -- HAWK System
        { multiple = {504.01, 504.02, 504.03, 504.04, 504.05}, desc = ctld.i18n_translate("HAWK - All crates"), side = 2 },		
        { multiple = {504.11, 504.12, 504.13}, desc = ctld.i18n_translate("NASAMS - All crates"), side = 2 },
        { weight = 504.01, desc = ctld.i18n_translate("HAWK Launcher"), unit = "Hawk ln", side = 2},
        { weight = 504.02, desc = ctld.i18n_translate("HAWK Search Radar"), unit = "Hawk sr", side = 2 },
        { weight = 504.03, desc = ctld.i18n_translate("HAWK Track Radar"), unit = "Hawk tr", side = 2 },
        { weight = 504.04, desc = ctld.i18n_translate("HAWK PCP"), unit = "Hawk pcp" , side = 2 },
        { weight = 504.05, desc = ctld.i18n_translate("HAWK CWAR"), unit = "Hawk cwar" , side = 2 },
        { weight = 504.06, desc = ctld.i18n_translate("HAWK Repair"), unit = "HAWK Repair" , side = 2 },
        -- End of HAWK

        -- NASAMS System
        { weight = 504.11, desc = ctld.i18n_translate("NASAMS Launcher 120C"), unit = "NASAMS_LN_C", side = 2},
        { weight = 504.12, desc = ctld.i18n_translate("NASAMS Search/Track Radar"), unit = "NASAMS_Radar_MPQ64F1", side = 2 },
        { weight = 504.13, desc = ctld.i18n_translate("NASAMS Command Post"), unit = "NASAMS_Command_Post", side = 2 },
        { weight = 504.14, desc = ctld.i18n_translate("NASAMS Repair"), unit = "NASAMS Repair", side = 2 },
        -- End of NASAMS

        --- RED
        -- KUB SYSTEM
        { multiple = {504.21, 504.22}, desc = ctld.i18n_translate("KUB - All crates"), side = 1 },
        { weight = 504.21, desc = ctld.i18n_translate("KUB Launcher"), unit = "Kub 2P25 ln", side = 1},
        { weight = 504.22, desc = ctld.i18n_translate("KUB Radar"), unit = "Kub 1S91 str", side = 1 },
        { weight = 504.23, desc = ctld.i18n_translate("KUB Repair"), unit = "KUB Repair", side = 1},
        -- End of KUB
    ...
    ["SAM long range"] = {
        --- BLUE
        -- Patriot System
        { multiple = {505.01, 505.02, 505.03}, desc = ctld.i18n_translate("Patriot - All crates"), side = 2 },
        { weight = 505.01, desc = ctld.i18n_translate("Patriot Launcher"), unit = "Patriot ln", side = 2 },
        { weight = 505.02, desc = ctld.i18n_translate("Patriot Radar"), unit = "Patriot str" , side = 2 },
        { weight = 505.03, desc = ctld.i18n_translate("Patriot ECS"), unit = "Patriot ECS", side = 2 },
        --{ weight = 505.04, desc = ctld.i18n_translate("Patriot ICC"), unit = "Patriot cp", side = 2 },
        --{ weight = 505.05, desc = ctld.i18n_translate("Patriot EPP"), unit = "Patriot EPP", side = 2 },
        --{ weight = 505.06, desc = ctld.i18n_translate("Patriot AMG"), unit = "Patriot AMG" , side = 2 },		
        { weight = 505.07, desc = ctld.i18n_translate("Patriot Repair"), unit = "Patriot Repair" , side = 2 },
        -- End of Patriot

        --BUK System
        { weight = 504.31, desc = ctld.i18n_translate("BUK Launcher"), unit = "SA-11 Buk LN 9A310M1", side = 1 },
        { weight = 504.32, desc = ctld.i18n_translate("BUK Search Radar"), unit = "SA-11 Buk SR 9S18M1", side = 1 },
        { weight = 504.33, desc = ctld.i18n_translate("BUK CC Radar"), unit = "SA-11 Buk CC 9S470M1", side = 1 },
        { weight = 504.34, desc = ctld.i18n_translate("BUK Repair"), unit = "BUK Repair", side = 1},
        { multiple = {504.31, 504.32, 504.33}, desc = ctld.i18n_translate("BUK - All crates"), side = 1 },
        -- END of BUK

		
		-- SA-2 SYSTEM
		--{ weight = 505.20, desc = ctld.i18n_translate("SA-2 Guidline Launcher"), unit = "S_75M_Volhov", side = 1 },
        --{ weight = 505.21, desc = ctld.i18n_translate("SA-2 Flat Face SR"), unit = "p-19 s-125 sr", side = 1 },
        --{ weight = 505.22, desc = ctld.i18n_translate("SA-2 Fan Song TR"), unit = "SNR_75V", side = 1 },
        --{ weight = 505.23, desc = ctld.i18n_translate("SA-2 CP"), unit = "RD_75", side = 1 },
        --{ weight = 505.16, desc = ctld.i18n_translate("SA-2 Repair"), unit = "SA-2 Repair", side = 1 },
        --{ multiple = {505.20, 505.21, 505.22, 505.23}, desc = ctld.i18n_translate("SA-2 - All crates"), side = 1 },
		-- End of SA-2
		
		
        -- S-300 SYSTEM
        --{ weight = 505.11, desc = ctld.i18n_translate("S-300 Grumble TEL C"), unit = "S-300PS 5P85C ln", side = 1 },
        --{ weight = 505.12, desc = ctld.i18n_translate("S-300 Grumble Flap Lid-A TR"), unit = "S-300PS 40B6M tr", side = 1 },
        --{ weight = 505.13, desc = ctld.i18n_translate("S-300 Grumble Clam Shell SR"), unit = "S-300PS 40B6MD sr", side = 1 },
        --{ weight = 505.14, desc = ctld.i18n_translate("S-300 Grumble Big Bird SR"), unit = "S-300PS 64H6E sr", side = 1 },
        --{ weight = 505.15, desc = ctld.i18n_translate("S-300 Grumble C2"), unit = "S-300PS 54K6 cp", side = 1 },
        --{ weight = 505.16, desc = ctld.i18n_translate("S-300 Repair"), unit = "S-300 Repair", side = 1 },
        --{ multiple = {505.11, 505.12, 505.13, 505.14, 505.15}, desc = ctld.i18n_translate("SA-10 - All crates"), side = 1 },
        -- End of S-300
    },
    ["Drone"] = {
        --- BLUE MQ-9 Repear
        { weight = 506.01, desc = ctld.i18n_translate("MQ-9 Repear - JTAC"), unit = "MQ-9 Reaper", side = 2 },
        -- End of BLUE MQ-9 Repear

        --- RED WingLoong-I
        { weight = 506.11, desc = ctld.i18n_translate("WingLoong-I - JTAC"), unit = "WingLoong-I", side = 1 },
        -- End of WingLoong-I
    },
}
...
ctld.jtacUnitTypes = {
    "Tigr_233036", "MaxxPro_MRAP", -- there are some wierd encoding issues so if you write SKP-11 it wont match as the - sign is encoded differently...
    "MQ", "RQ", "WingLoong"					--"MQ-9 Repear", "RQ-1A Predator", "WingLoong-I"}
}
...
ctld.AASystemTemplate = {

    {
        ...
        count = 5,
        parts = {
            {name = "Hawk ln", desc = "HAWK Launcher", launcher = true, amount = 5 },
    ...
    },
    {
        ...
        count = 3,
        parts = {
            {name = "Patriot ln", desc = "Patriot Launcher", launcher = true, amount = 4},
    ...
    },
    {
        ...
        count = 3,
        parts = {
            {name = "NASAMS_LN_C", desc = "NASAMS Launcher 120C", launcher = true, amount = 4},
    ...
    },
	{
        ...
        count = 3,
        parts = {
            {name = "SA-11 Buk LN 9A310M1", desc = "BUK Launcher" , launcher = true, amount = 3},
    ...
    },
    {
        ...
        count = 2,
        parts = {
            {name = "Kub 2P25 ln", desc = "KUB Launcher", launcher = true, amount = 3},
    ...
    --},
    {
        ...
        count = 4,
        parts = {
            { desc = "S_75M_Volhov", name = "SA-2 Guidline Launcher", launcher = true, amount = 4 },
            { desc = "p-19 s-125 sr", name = "SA-2 Flat Face SR"},
            { desc = "SNR_75V", name = "SA-2 Fan Song TR"},
            { desc = "RD_75", name = "SA-2 CP"},
        },
        repair = "SA-2 Repair",
    },
    {
        ...
        count = 2,
        parts = {
            { desc = "HQ-7_Launcher", name = "HQ-7_LN_SP", launcher = true, amount = 2 },
            { desc = "HQ-7_STR_SP", name = "HQ-7_STR_SP"},
        },
        repair = "HQ-7 Repair",
    },	
	{
		...
		parts = {
			...
			{name = "rapier_fsa_optical_tracker_unit", desc = "Rapier Tracker"},
			{name = "rapier_fsa_blindfire_radar", desc = "Rapier SR"},
		},
...
function ctld.spawnFOB(_country, _unitId, _point, _name)
    ...
    local _crate = {
     ...
     --   ["unitId"] = _id,
        ...
        ["y"] = _point.z + -10.00,
        ["x"] = _point.x + -5.00,
        ["name"] = "FARP Ammo Dump Coating #" .. _id,
        ["category"] = "Structures",
        ["canCargo"] = true,
        ["heading"] = 0,
    }
    ...
    --local _spawnedCrate = coalition.addStaticObject(_country, _crate)
		...
		["shape_name"] = "Container_watchtower_lights",
     --   ["unitId"] = _id,
        ["rate"] = 350,
        ["y"] = _point.z + 20.00,
        ["x"] = _point.x + -5.00,
        ["name"] = "Container_watchtower_lights #" .. _id,
        ["category"] = "Structures",
        ["canCargo"] = false,
        ["heading"] = 0,
	}
...
ctld.randomCrateSpacing = 0 -- meters
...
function ctld.getPointAtDirection(_unit, _offset, _directionInRadian)
    ...
    local _randomOffsetX = math.random(ctld.randomCrateSpacing * 0 ) - ctld.randomCrateSpacing
        ...
        for _, _crate in pairs(_crates) do
            ...
            if _crate.dist < 50.0 then
                if #ctld.inTransitSlingLoadCrates[_name] < _cargoCapacity then
                    ...
                    -- Max crates onboard
                    local outputMsg = ctld.i18n_translate("Crate Loaded!")
                ...
                elseif _crate.details.cratesRequired ~= nil and _crate.details.cratesRequired > 1 then
                  ...
                  --  if ctld.slingLoad == false then
                   ...
                   -- end
                    ...
                    if _crate.details.unit == "FPS-117" then
                        ctld.addEWRTask(_spawnedGroups)
...
function ctld.dropSlingCrate(_args)
    ...
    if _currentCrate == nil then
        ...
        for _, _crate in pairs(_loadedCratesCopy) do
            ...
            elseif _heightDiff > 7.5 and _heightDiff <= 50.0 then
...
function ctld.unpackAASystem(_heli, _nearestCrate, _nearbyCrates,_aaSystemTemplate)
    ...
    local spawnDistance = 30 -- circle radius to spawn units in a circle and randomize position relative to the crate location
...
function ctld.spawnCrateGroup(_heli, _positions, _types, _hdgs)
    ...
    if _types[1] ~= "MQ-9 Reaper" and _types[1] ~= "WingLoong-I" then  -- non-drones - JTAC
        local _spreadMin = 0
        local _spreadMax = 0
        local _spreadMult = 1
        for _i, _pos in ipairs(_positions) do
			...
			_group.units[_i] = ctld.createUnit(_pos.x + 0, _pos.z + 0, mist.getHeading(_heli, true), _details)		
        end
        _group.category = Group.Category.GROUND
    else        -- drones - JTAC
        local _unitId = ctld.getNextUnitId()
            ...
            local _unitTypename = _unit:getTypeName()
                ...
                if _groupId then
                    ...
                    if ctld.addedTo[tostring(_groupId)] == nil then
						...
						if ctld.enabledRadioBeaconDrop then
                            local _radioCommands = missionCommands.addSubMenuForGroup(_groupId, ctld.i18n_translate("CTLD Pilots Read This"), _rootPath)
							missionCommands.addCommandForGroup(_groupId, ctld.i18n_translate("We use the unarmed Hummer as the CTLD crate because they will not stack up on top of each other causing issues for hovering helicopters to pick up crates. Multiple crates will appear as one until moved.  To prevent the stacking, the original programming spread out the crates randomly within a 12m circle in front of the chopper.  This caused an issue trying to place a single crate where you want it and now it places your dropped crate 30m directly in front of the chopper.  When building a large sam site, spread the pieces out, don't place the launchers on top of the radars.  Allow space for them.  Don't build a launcher crate near a runway or taxiway, it may spread onto them when built. MOVE AWAY FROM THE SITE SO IT DOESN'T BUILD AND DESTROY YOUR CHOPPER"), _radioCommands, ctld.listRadioBeacons,{ _unitName })                  
						end
...
function ctld.getPositionString(_unit)
    ...
    return " @\n- DD " .. _latLngStr .." \n- DMS: " .. _latLngSecStr  .. " \n- MGRS: " .. _mgrsString .. " - ALTI: " .. mist.utils.round(_TargetAlti, 0) .. " m / " .. mist.utils.round(_TargetAlti/0.3048, 0) .. " ft"
end
...
-- === Welcome-on-spawn for CTLD helicopters (no double message) ===
local _ctldTypeSet = {}
do
    for k, v in pairs(ctld.aircraftTypeTable or {}) do
        if type(k) == "string" then _ctldTypeSet[k] = true end
        if type(v) == "string" then _ctldTypeSet[v] = true
        elseif type(v) == "table" and v.type then _ctldTypeSet[v.type] = true end
    end
end

local function _isCtldChopper(u)
    if not u or not Unit.isExist(u) then return false end
    local ut = u:getTypeName()
    return ut and _ctldTypeSet[ut] == true
end

local function _welcomeUnit(u)
    if not u or not Unit.isExist(u) then return end
    timer.scheduleFunction(function()
        if not Unit.isExist(u) then return end
        if u:getPlayerName() and _isCtldChopper(u) then
            trigger.action.outTextForUnit(u:getID(), "When building a SAM site spread the crates out so they don't spawn together.  Keep launcher crates away from the other SAM parts, taxiways and runways.  Move your chopper away from the launcher crate so the spawning launchers don't damage your chopper.", 40)
        end
    end, {}, timer.getTime() + 0.1)
end

local WelcomeHandler = {}
function WelcomeHandler:onEvent(e)
    if e.id == world.event.S_EVENT_PLAYER_ENTER_UNIT and e.initiator then
        _welcomeUnit(e.initiator)
    end
end
world.addEventHandler(WelcomeHandler)
-- === End ===
